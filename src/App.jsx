...
const CLUBS = [
  { id:1, name:"Club Informatique", icon:"💻", desc:"Développement, hackathons et projets tech entre passionnés.", members:50, max:50, color:"linear-gradient(90deg,#4f6ef7,#a78bfa)", cat:"Tech",    c:"#4f6ef7" },
